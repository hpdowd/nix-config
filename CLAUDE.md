...
- `nix flake check` — builds the system + home closure, runs statix/deadnix; run before any rebuild
...
- `verify-claims.sh` — re-checks CLAUDE.md's assertions against the **live** system, which no build can see
